...
Codes by default. Translate with `type = "label"` or
...
codes.
[`brreg_label()`](https://sondreskarsten.github.io/tidybrreg/reference/brreg_label.md)
translates to English via bundled reference data or live SSB Klass API
lookups.
...
**Two panel construction paths.** Multi-snapshot diff
([`brreg_panel()`](https://sondreskarsten.github.io/tidybrreg/reference/brreg_panel.md))
for historical analysis. Single snapshot + CDC replay
